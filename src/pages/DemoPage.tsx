							...
							<Reveal>
								<div className='flex flex-col gap-5'>
									...
									<p className='text-lg text-slate-600 dark:text-slate-300'>
										Talabalar uchun mo'ljallangan maxsus chegirmalar va
										xizmatlardan foydalanish tizimining to'liq ishlash jarayoni
										bilan tanishing.
									</p>
								</div>
							</Reveal>
							...
							<Reveal y={18}>
								<GlassPanel className='relative overflow-hidden p-8'>
									...
									<p className='mt-4 text-sm text-slate-600 dark:text-slate-300'>
										TalabaHub — Talabalar hayotini qulayroq va tejamkor
										qiladigan yangi avlod chegirmalar platformasi.
									</p>
								</GlassPanel>
							</Reveal>
						</div>
							...
							<Reveal y={18}>
								<div className='flex flex-col gap-4'>
									...
									<p className='text-sm text-slate-600 dark:text-slate-300'>
										Ushbu video TalabaHub platformasining to'liq ishlash
										jarayonini namoyish etadi. Talaba sifatida tizimga
										ro'yxatdan o'tish, talabalik maqomini tasdiqlash, hamkor
										do'konlar, restoranlar, food marketlar va xizmat ko'rsatish
										markazlaridagi chegirmalarni topish hamda ulardan
										foydalanish jarayoni real vaqt rejimida ko'rsatiladi.
									</p>
									<p className='text-sm text-slate-600 dark:text-slate-300'>
										Shuningdek, har bir chegirma uchun maxsus kod yoki QR orqali
										to'lov vaqtida chegirmadan foydalanish, saqlangan
										chegirmalarni boshqarish va shaxsiy kabinet orqali barcha
										foydalanilgan chegirmalarni kuzatish imkoniyati batafsil
										tushuntiriladi.
									</p>
									<p className='text-sm text-slate-600 dark:text-slate-300'>
										Hamkor kompaniyalar esa o'z admin paneli orqali
										chegirmalarni qo'shish, filiallar bo'yicha aksiyalarni
										boshqarish va talabalar oqimini monitoring qilish
						...
						<div className='grid gap-6 lg:grid-cols-2'>
							<Reveal>
								<GlassPanel className='p-8'>
									...
									<p className='mt-4 text-sm text-slate-600 dark:text-slate-300'>
										Bugungi kunda ko'plab talabalar kundalik xarajatlarda
										chegirma imkoniyatlaridan bexabar yoki ulardan foydalanish
										qiyin. Kompaniyalar esa talabalar uchun maxsus takliflar
										yaratishni xohlasalar ham, buni samarali tarqatish
										platformasiga ega emas.
									</p>
									<p className='mt-4 text-sm text-slate-600 dark:text-slate-300'>
										TalabaHub aynan shu muammoni hal qilish uchun yaratilgan.
										Platforma orqali talabalar uchun maxsus chegirmalar bir
										joyda jamlanadi va faqat tasdiqlangan talabalar ulardan
							...
							<Reveal>
								<GlassPanel className='p-8'>
									<h3 className='text-xl font-semibold text-slate-900 dark:text-white'>
										Tizimda quyidagi funksiyalar mavjud
									</h3>
									<Stagger
										as='ul'
										className='mt-4 space-y-3 text-sm text-slate-600 dark:text-slate-300'
						...
						<Reveal>
							<div className='relative overflow-hidden rounded-[36px] border border-white/10 bg-gradient-to-br from-slate-900 via-slate-900 to-indigo-900 px-8 py-10 text-center text-white shadow-soft sm:px-10'>
								...
								<p className='mt-3 text-sm text-slate-200 sm:text-base'>
									Platformaning to'liq funksional demosini ishlatib ko'ring va
									risk baholash jarayonini o'z ko'zingiz bilan ko'ring.
								</p>
