...
const HeroSection: React.FC = () => {
  ...
  const chipVariants: Array<'blue' | 'green' | 'teal'> = ['blue', 'green', 'teal']

  return (
    <section id="hero" className="section-base section-fog section-fog--hero pb-20 pt-36">
      ...
      <Container>
        <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr]">
          <Stagger animateOnMount>
            <Reveal withParent>
              <p className="text-sm font-semibold uppercase tracking-[0.3em] text-cyan-500">TalabaHub</p>
            </Reveal>
            <Reveal withParent>
            ...
            <Reveal withParent>
              <div className="mt-4 flex max-w-xl flex-col gap-1 text-sm text-slate-600 dark:text-slate-300">
                <span className="font-semibold text-slate-800 dark:text-slate-100">{t('hero.statsLine')}</span>
                <span className="text-xs text-slate-500 dark:text-slate-400">{t('hero.statsSource')}</span>
              </div>
            </Reveal>
            ...
            <Reveal withParent>
              <div className="mt-8 flex flex-wrap gap-4">
                <a href="https://talaba-hub.vercel.app/" className={buttonStyles('primary')}>
                  {t('hero.ctaPrimary')}
                </a>
                <a
                  href="#demo"
